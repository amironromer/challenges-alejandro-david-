...
def sum_dice(roll1, roll2):
  sum_dice = roll1 + roll2
  if sum_dice <= 6:
      print(f"The sumn of your dice is {sum_dice}, unfortunate. ")
  elif sum_dice >= 6 or sum_dice <= 10:
      print(f"The sum of you dice is {sum_dice}. You have a good chance.")
  elif sum_dice >= 10:
